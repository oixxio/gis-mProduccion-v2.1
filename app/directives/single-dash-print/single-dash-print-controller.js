(function () {
    ...
    function singleDashPrintCtrl ($location, linkFactory, databaseFactory, parser, $mdMedia, $scope, $timeout, $rootScope, common,$window,$anchorScroll,$mdDialog) {
		...
		$timeout(function(){printAndRedirect( redirect ,print );}, 3500);
		...
		function populateMap() {
			...
			for (var i = 0; i < self.regionPolygons.length; i++) {
				...
				console.log(self.regionPolygons[i].setMap(self.mapObject));
			}
